...
var tags_name =
    new Array("Tučně","Kurzíva","Podtržení","Odkaz","Barva","Velikost");
var tags_img =
...
function ot2html_writeHistory() {
    document.writeln("Otevřené tagy:<br /><textarea name=\"editorH-" + this.id + "\" id=\"editorH-" + this.id + "\" cols=\"15\" rows=\"10\" readonly=\"readonly\"></textarea><br />");
}
