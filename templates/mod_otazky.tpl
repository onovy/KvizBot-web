...
<a href='pravidla_otazky.htm'>Pravidla</a>, které musí splňovat všechny otázky.<br />
<a href='licence-otazek.htm'>Licence</a>, pod kterou jsou všechny otázky přidávány.

{if $auth->perm_o|default:false}
<h3>Editace</h3>
<a href='?w=add'>Přidat otázku</a>
<table border=0>
<form method='get'>
