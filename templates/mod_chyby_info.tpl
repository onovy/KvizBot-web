...
<p>
<a href='?w=list&amp;filter=open'>Zpět na seznam chyb</a>
</p>
...
<tr>
    ...
    <td></td>
    <td>Komentář: <textarea name='comment'>{$info->comment|escape}</textarea></td>
</tr><tr>
    <td></td>
